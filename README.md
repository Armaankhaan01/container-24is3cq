...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-24is3cq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-24is3cq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Armaankhaan01/container-24is3cq.git
cd container-24is3cq
```
...
```
docker attach container-24is3cq
```
